          ...
          body: SafeArea(
            child: Column(
              children: [
                ...
                if (state.connectivity == ConnectivityType.offline)
                  Padding(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "SOS calls, SMS fallback & medical ID remain fully operational.",
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        QuickServicesRow(
                          ...
                          onTap: (section) async {
                            // Quick row: 0=hospitals, 1=police, 2=towing, 3=contacts
                            final emergencySection = section == 3 ? 4 : section;
                            await context.push('/emergency?section=$emergencySection');
                          },
                        ),
