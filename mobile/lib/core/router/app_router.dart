...
import '../../features/crash_detection/crash_detected_screen.dart';
  ...
  static GoRouter router(String initialLocation) {
    ...
    return GoRouter(
      ...
      redirect: (context, state) {
        debugPrint("REDIRECT_CHECK_STARTED");
        try {
          ...
          debugPrint("REDIRECT_SAFE_FALLBACK: error during redirect: $e");
          return '/login';
        }
      },
      routes: [
        ...
        GoRoute(
          path: '/crash_detected',
          parentNavigatorKey: rootNavigatorKey,
          builder: (context, state) => const CrashDetectedScreen(),
        ),
        GoRoute(
          path: '/onboarding',
          parentNavigatorKey: rootNavigatorKey,
